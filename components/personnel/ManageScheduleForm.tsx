            ...
            <form action="" onSubmit={onsubmit} className="w-[400px]">
                <div>
                    <select value={selectedId} onChange={handleChange}>
                        ...
                        {personnel && personnel.map((person: Personnel) => (
                ...
                <Button type='submit' className='mt-40'>Submit</Button>
            </form>
                            ...
                            {['mañana', 'tarde'].map(period => {
                                ...
                                return (
                                    <td key={period}>
                                        <input
                                            type="checkbox"
                                            checked={daySchedule ? daySchedule.turno === period || daySchedule.turno === 'ambos' : false}
                                            onChange={() => handleCheckboxChange(dia as Day, period as Period)}
                                        />
                                    </td>
                                );
                            })}
