...
import { Button } from "./button"; // Assuming Button, ButtonVariant, and ButtonSize are defined in './button'
...
const NavBar: React.FC<NavBarProps> = () => {
  return (
    <header className="fixed top-0 left-0 w-full bg-white shadow-md z-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between h-16">
        <Link href="#" className="flex items-center gap-2">
            <Image src="/EzTransparentLogo.png" width="100" height="100" alt="Logo" />
